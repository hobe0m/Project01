package org.RentalProject.RentalService.restcontrollers;
...
// @RestControllerAdvice : 지정된 경로에 속하는 모든 RestController 클래스에서 발생하는 예외를 처리
@RestControllerAdvice("org.RentalProject.RentalService.restcontrollers")
public class RestCommonController {

    // restcontrollers 폴더에서 발생하는 예외는 모두 Exception.class로 유입된다.
    // 지정된 예외 타입('Exception.class')에 대한 처리를 담당한다.
    // 여기서는 모든 예외에 대한 처리 수행
